...
# options
test_img_folder_name = 'me'  # image folder name

test_img_folder = '/srv/wuyichao/Super-Resolution/KPSAGAN/datasets/' + test_img_folder_name  # HR images
save_prob_path = '/srv/wuyichao/Super-Resolution/KPSAGAN/datasets/' + test_img_folder_name + '_segprob'  # probability maps
save_byteimg_path = '/srv/wuyichao/Super-Resolution/KPSAGAN/datasets/' + test_img_folder_name + '_byteimg'  # segmentation annotations
save_colorimg_path = '/srv/wuyichao/Super-Resolution/KPSAGAN/datasets/' + test_img_folder_name + '_colorimg'  # segmentaion color results
...
model_path = '/srv/wuyichao/Super-Resolution/KPSAGAN/pretrained_model/segmentation_OST_bic.pth'
